...
{
	public Texture t;
	private int index = 1; // 1 is 'x' key, refer to power up manager
	...
	void Start()
    {
		GameManager.OnPlayerDeath += DestroyMushroomOrange;
		GameManager.OnGameReset += DestroyMushroomOrange;
